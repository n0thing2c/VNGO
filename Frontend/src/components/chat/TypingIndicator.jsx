...
const TypingIndicator = memo(({ contactName, contactAvatar, roomName }) => {
  const displayName = contactName || "Someone";
  const isChatbot = roomName?.endsWith("chatbot");
  ...
  return (
    <div className="flex items-end gap-2 justify-start">
      ...
      <div className="max-w-xs lg:max-w-md px-4 py-2 rounded-lg bg-gray-100 text-gray-900 rounded-bl-none">
        <div className="flex items-center gap-1">
          <span className="text-xs text-gray-500 italic">{displayName} is typing</span>
