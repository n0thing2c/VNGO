  ...
  return (
    <div className={`flex flex-col h-[100%]`}>
      ...
      <div className="flex-1 overflow-y-auto relative ">
        <div
          className={`pointer-events-none absolute inset-0 bg-white/70 backdrop-blur-sm flex items-center justify-center transition-opacity duration-300 ${isRefreshing ? "opacity-100" : "opacity-0"}`}
        >
