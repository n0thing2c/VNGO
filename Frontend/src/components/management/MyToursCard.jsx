...
import { Clock, Users, Star, DollarSign, BookOpen, CheckCircle, AlertCircle, Edit, Trash2 } from "lucide-react";
import {
    AlertDialog,
    AlertDialogTrigger,
    AlertDialogContent,
    ...
    return (
        <div
            ...
            <div className="p-2 md:p-6 flex-1 flex flex-col">
                ...
                {/* Location */}
                {tour.location && (
                    <p className="text-xs md:text-sm text-gray-600 mb-1.5 md:mb-3 line-clamp-1"> {tour.location}</p>
                )}
                ...
                <div className="flex flex-row md:flex-row gap-2 md:gap-3 mt-auto">
                    <Button
                        onClick={handleEditClick}
                        className="flex-1 justify-center gap-2 rounded-full border border-[#4673E6] text-[#4673E6] bg-transparent h-7 md:h-10 text-xs md:text-sm btn-vngo-hover-effect hover:bg-white hover:text-[#4673E6]"
                    >
                    ...
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button
                                ...
                                variant="outline"
                                className="flex-1 rounded-full h-7 md:h-10 text-xs md:text-sm border border-[#CC3737] text-[#CC3737] bg-transparent btn-vngo-hover-effect hover:bg-white hover:text-[#CC3737]"
                            >
                        ...
                        >
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                    onClick={(e) => {
                                        e.stopPropagation(); // STOP card click here too
                                        onDelete?.(tour.id);
                                    }}
