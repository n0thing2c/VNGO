        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 xl:col-span-3 flex flex-col space-y-4 p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="flex flex-col items-center space-y-2">
              <div className="relative h-40 w-40 md:h-48 md:w-48 rounded-full overflow-hidden border-2 border-white ring-2 ring-gray-300">
                <img
            ...
            <Button
              className={`w-full mt-4 rounded-full flex items-center justify-center gap-2 btn-vngo-hover-effect ${
                userRole === "tourist"
          ...
          <div className="lg:col-span-8 xl:col-span-9 w-full space-y-6">
            ...
            <div className="pt-10 px-8 pb-8 bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              {/* Achievements badges */}
              <div className="flex flex-wrap gap-6 mb-10 scale-125 origin-left">
                {achievements?.length > 0 ? (
                  achievements.map((ach, idx) => (
                    <AchievementBadge
                      key={idx}
                      variant={ach.toLowerCase()}
                      label={ach}
                    />
                  ))
                ) : (
                ...
                <>
                  <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden mb-4">
                    <div
                      ...
                      style={{
                        width: `${(guide.stats.achievement_count / 5) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <p className="text-base md:text-lg text-vngo-primary">
                    {guide.stats.achievement_count} / 5 achievements unlocked
                  </p>
                </>
              )}
            </div>
            ...
            {guide.stats && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Past Tours Box */}
                <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-200 flex items-start gap-4">
                ...
                <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-200 flex items-start gap-4">
                  <div className="p-3 bg-purple-50 rounded-lg flex items-start justify-center">
                    <LandPlot className="w-10 h-10 text-purple-600" />
                  </div>
                  <div className="flex flex-col justify-between h-full">
                    <p className="text-gray-600 text-sm leading-tight">
                      Hosted tours
