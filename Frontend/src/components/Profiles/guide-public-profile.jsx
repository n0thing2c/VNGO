...
const TourCard = ({ tour, onViewTour }) => (
  <div className="flex flex-col min-w-[300px] w-[300px] h-[400px] bg-white rounded-lg overflow-hidden shadow-md border border-gray-100">
    <img
      src={tour.image}
      alt={tour.title}
      ...
      <div className="w-full max-w-[1000px] mx-auto px-4 sm:px-8 pt-8">
        <div className="flex flex-col space-y-8 pb-12">
              ...
              <div className="relative -mt-16 md:-mt-20 mb-4">
                <Dialog>
                  <DialogTrigger asChild>
                    <div className="relative h-32 w-32 md:h-40 md:w-40 rounded-full overflow-hidden border-4 border-white shadow-lg cursor-pointer">
                      <img
          ...
          <div className="w-full flex flex-col space-y-4 p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-10 gap-3 mb-6 w-full max-w-full justify-center">
          ...
          <div className="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            {tours.length === 0 ? (
              ...
              <div className="flex items-center gap-4">
                <Button
                  className="p-2 rounded-full bg-white border border-gray-200 hover:bg-gray-100 shadow-sm hidden md:flex items-center justify-center shrink-0"
