...
classDiagram
    ...
    class Booking {
        ...
        +save() (auto-calculates total_price)
    }
    ...
    class Call {
        ...
        +int caller_id FK
        +int callee_id FK
        +string call_type [audio|video]
        +string status [pending|ringing|accepted|rejected|missed|ended|failed]
        +datetime created_at
    ...
    User "1" --o "0..*" RoomLastSeen : tracks
    User "1" --o "0..*" Call : calls (outgoing)
    User "1" --o "0..*" Call : receives (incoming)
...
| User ↔ RoomLastSeen                    | 1:n         | ForeignKey                     | CASCADE   |
| User ↔ Call (caller)                   | 1:n         | ForeignKey                     | CASCADE   |
| User ↔ Call (callee)                   | 1:n         | ForeignKey                     | CASCADE   |
